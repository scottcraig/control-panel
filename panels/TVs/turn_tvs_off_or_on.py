...
def turn_tvs_off_or_on():
    ...
    while not_quitting:
        ...
        if user_input == 'n':
            ...
            utils.print_error(
                "Sorry, I didn't understand \"{}\".  Hit 'n' for on or 'f' for off.".format(user_input))
            continue
        ...
        if user_input == 'q':
            ...
            utils.print_error(
                "Sorry, I didn't understand \"{}\".  Hit Enter to turn them all off, or enter a number for a specific TV.".format(user_input))
            continue
